...
export class DynamoDBService {
  ...
  async insert<T>(
    ...
    try {
      ...
      const conditionExpression =
        ...
        (pk.sort
          ? ` AND attribute_not_exists(${pk.sort.attribute.toString()})`
          : "");
  ...
  async update<T>(
    ...
    try {
      ...
      const conditionExpression =
        ...
        (pk.sort
          ? ` AND attribute_exists(${pk.sort.attribute.toString()})`
          : "");
  ...
  private createFilterExpression<T>(
    itemPrimaryKey: ItemPrimaryKey<T>
